<?php $page="shipping-logistics"; include("includes/second-header.php"); ?>
<style>
    .services-thumb img{
        height: 400px;
    }
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="breadcrumb__content">
                    <h2 class="title">Shipping & Logistics</h2>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href='/'>Home</a></li>
                            <li class="breadcrumb-item" aria-current="page"><a href='/'>Industries</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Shipping & Logistics</li>
                        </ol>
                    </nav>
                </div>
            </div>
