...
<section class="about__area-six">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-six">
                            ...
                            <p>Humantroop Ventures Services regularly holds awareness and gender sensitization sessions mandated by the Sexual Harassment of Women at the Workplace (Prevention, Prohibition and Remediation) Act 2013. These sessions, colloquially called "POSH training or POSH Act training", help employees gain the necessary clarity between acceptable and unacceptable behavior in the context of the law.</p>
            ...
            <div class="about__shape-wrap-four">
                ...
                <img src="assets/img/images/h4_about_shape02.png" alt="" data-parallax="{&quot;x&quot; : -80 , &quot;y&quot; : -80 }" style="transform:translate3d(-55.066px, -55.066px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(-55.066px, -55.066px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
            </div>
        </section>
        ...
        <section class="services__area-three services__bg-three" data-background="assets/img/bg/h3_services_bg.jpg" style="background-image: url(&quot;assets/img/bg/h3_services_bg.jpg&quot;);">
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="about__content-four">
                            <div class="section-title mb-30">
                                ...
                                <br>
                                <h6>The Government of India introduced the Workplace Sexual Harassment of Women Act (also colloquially known as the "POSH Act"), 2013 in India to effectively deal with matters related to sexual harassment of women in their workplace.</h6>
                            </div>
                        ...
                        <div class="accordion-container">
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <p>All workplaces within India including public or private sector, government, or non-government organizations.</p>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header">
                                    When does it become mandatory for the Employer to constitute an Internal Committee (IC)? <span class="icon"></span>
                                </button>
                                <div class="accordion-content">
                                    <p>When the number of employees crosses 10 in an organization (and that has female employees), it is mandatory for the Employer to constitute an Internal Committee.</p>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <button class="accordion-header">
                                    Does the POSH Act apply to organizations employing less than 10 employees? <span class="icon"></span>
                                </button>
                                <div class="accordion-content">
                                    <p>Yes, POSH Act applies to workplaces with less than ten employees. However, in such a scenario formation of IC is not mandatory.</p>
                                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <p>CEO, Managing Director, Proprietor, Managing Partner, Directors, owners of business and all such parties who construe as ‘Employers’ would be held responsible for POSH non-compliance.</p>
                                </div>
        ...
        <section class="about__area-six">
            ...
            <div class="about__shape-wrap-four">
                <img src="assets/img/images/h4_about_shape01.png" alt="">
                <img src="assets/img/images/h4_about_shape02.png" alt="" data-parallax="{&quot;x&quot; : -80 , &quot;y&quot; : -80 }" style="transform:translate3d(-23.545px, -23.545px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); -webkit-transform:translate3d(-23.545px, -23.545px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scaleX(1) scaleY(1) scaleZ(1); ">
            </div>
        </section>



        <section class="services-area services-bg" data-background="assets/img/bg/services_bg.jpg" style="background-image: url(&quot;assets/img/bg/services_bg.jpg&quot;);">
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                ...
                                <div class="services-content">
                                    ...
                                    <p>There are other non-compliance provisions. Employers will face double punishment and will be re-sentenced if they have previously been convicted of an offense punishable under the POSH Act.
