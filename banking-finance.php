<?php $page="banking-finance"; include("includes/second-header.php"); ?>
            ...
            <div class="col-lg-6">
                <div class="about__content-three">
                    <div class="section-title mb-25">
                        <h2 class="title">Because change is a given, we can help you move fast while minimizing risk</h2>
                    </div>
                    <p>The financial industry faces many challenges, including keeping a growing workforce up-to-date with regulatory compliance, filing financial certifications and credentials, and securing data and systems. We can help simplify your life with easy-to-use solutions so you can focus on growing your business and your employees.</p>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="choose-content">
                    ...
                    <p>We talk to our financial clients about their day-to-day challenges – such as compliance in a highly regulated environment – ​​and then combine their input with our industry expertise. Result? Solutions that meet the needs of the financial services environment, including:</p>
                    <div class="choose-list">
                        <ul class="list-wrap">
                            <li>
                                ...
                                <div class="content">
                                    <h4 class="title">Manage, administer and monitor compliance training</h4>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h4 class="title">Plan and manage employee benefits, all on one secure platform</h4>
                                </div>
                            </li>
                        </ul>
                    </div>
