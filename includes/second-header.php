...
<body>
    ...
    align-items: center;">
                                ...
                                <li><a href="https://www.linkedin.com/company/humantroop"><i class="fab fa-linkedin-in"></i></a></li>
                                <li></li>
                            </ul>
                            <a class="sac" href="https://calendly.com/humantroop-ventures">Schedule a Call</a>
                        </div>
        ...
        <div class="offCanvas__info">
            <div class="contact__form-wrap">
                ...
                <div class="form-grp">
                    ...
                    <div class="form-grp">
                    <input type="tel" name="float-contact" placeholder="*Contact" class="input_filed">
                    </div>
                    <div class="form-grp">
                    <textarea class="form-grp" placeholder="*Comment" name="msg" required></textarea>
                    </div>
                    <div class="form-grp">
...
.offCanvas__info.active{
  ...
  <li class="floating-li"><a class="menu-tigger" href="http://43folderstech.net"> Employer Call Back Request</a></li>
</ul>
