<?php $page="manufacturing"; include("includes/second-header.php"); ?>
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="about__content-three">
                    ...
                    <h2 class="title">Spend more time producing — with better payroll and time tracking</h2>
<p>On the production line, every minute counts. Delays or downtime caused by security breaches, employee absences, or miscommunication can result in lost productivity and revenue. We can help keep your production line moving with easy-to-use solutions so your equipment stays safe and productive.</p>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="choose-content">
                    ...
                    <p>We talk to our manufacturing clients about their day-to-day challenges—like making sure employees are properly compensated—and then combine their input with our industry expertise. Result? Solutions that meet manufacturing needs, including:</p>
                    <div class="choose-list">
                        <ul class="list-wrap">
                            <li>
                                ...
                                <div class="content">
                                    <h4 class="title">Makes it easy to create and fill out schedules and track attendance</h4>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h4 class="title">Aligning multiple jobs and multiple pay rates to help ensure employees are compensated correctly</h4>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h4 class="title">Communication of shifts, productivity goals, and safety information</h4>
                                </div>
                            </li>
                        </ul>
                    </div>
