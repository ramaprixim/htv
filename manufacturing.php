        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-10">
                <div class="about__img-wrap-four">
                    <img src="assets/img/images/industries - Manufacturing -Spend more time producing — with better payroll and time tracking.png" alt="">
            ...
            <div class="col-lg-6">
                <div class="about__content-three">
                    ...
                    <p>On the production line, every minute counts. Delays or downtime caused by security breaches,
                        employee absences, or miscommunication can result in lost productivity and revenue. We can help
                        keep your production line moving with easy-to-use solutions so your equipment stays safe and
                        productive.</p>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="choose-img-wrap">
                    <img src="assets/img/images/industries - Manufacturing - Designed with input from.png"
                        alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="choose-content">
                    ...
                    <p>We talk to our manufacturing clients about their day-to-day challenges—like making sure employees
                        are properly compensated—and then combine their input with our industry expertise. Result?
                        Solutions that meet manufacturing needs, including:</p>
