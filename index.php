        ...
        <div class="choose-area ptb-100">
            <div class="container">
                <div class="section-title">
                    ...
                    <h2>Thy Trust Partners For Occupation</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi lacus, dignissim phareta lorem. Sed ut lacus aliquet, volutpat sem pellentesque, egestas nisl.</p>
                </div>
                ...
                <div class="tab-teaser">
                    <div class="tab-menu">
                      <ul>
                        <li><a href="#" class="active" data-rel="tab-1">Top Software Developers</a></li>
                        <li><a href="#" data-rel="tab-2" class="">Fast-Growing Company</a></li>
                        <li><a href="#" data-rel="tab-3" class="">100% Client Satisfaction</a></li>
                      </ul>
                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="choose-content pr-15">
                                        <div class="choose-title">
                                            ...
                                            <h2>Protect Your Business And Family Through Insurance</h2>
                                        ...
                                        <div class="choose-features-list">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p>First, you’ll reach out to an agency that specializes in your industry, specifying information like the job responsibilities.</p>
                                                </li>
                                                <li>
                                                    <div class="number">
                                                        <span>02</span>
                    ...
                    <div class="tab-box" id="tab-3">
                        <div class="choose-tab-items">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="choose-img pl-15">
                                        <img src="assets/images/choose/choose-img-4.jpg" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>    
