...
/* .swiper-container>.swiper-wrapper>.swiper-slide{
    width: 48% !important;
        ...
        <section class="slider__area">
            <div class="swiper-container slider__active swiper-container-fade swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-5442b7695bd6d296" aria-live="off" style="transition-duration: 0ms;"><div class="swiper-slide slider__single swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="1" role="group" aria-label="1 / 4" style="width: 1903px; opacity: 1; transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="slider__content">
                                        <h2 class="title">Humantroop Ventures is one of the top HR consultant in Navi Mumbai. Our team of consultants are highly capable of developing and implementing simple, practical, yet powerful HR solutions that deliver superior business results</h2>
        ...
        <section class="blog__post-area-five">
            ...
            <div class="blog-shape-wrap">
                <img src="assets/img/images/h5_blog_shape01.png" alt="" data-aos="fade-right" data-aos-delay="400" class="aos-init aos-animate">
                <img src="assets/img/images/h5_blog_shape02.png" alt="" data-aos="fade-left" data-aos-delay="400" class="aos-init aos-animate">
            </div>
        </section>
                        ...
                        <div class="consulting-inner-wrap shine-animate-item">
                            <div class="consulting-content">
                                ...
                                <div class="content-right">
                                    <h4 class="text-light">Humantroop Ventures is one of the top HR consultant in Navi Mumbai. Our team of consultants are highly capable of developing and implementing simple, practical, yet powerful HR solutions that deliver superior business results</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            <div class="section-title mb-35 tg-heading-subheading animation-style3">
                                ...
                                <h2 class="title tg-element-title">We believe in providing personalized solutions to our clients.</h2>
                                ...
                                <ul class="list-wrap">
                                    <li>
                                        ...
                                        <div class="content">
                                            ...
                                            <p>A happy workforce is productive and helps you focus on increasing profitability.</p>
                                        </div>
                                    </li>
                                    <li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                <div class="services-thumb">
                                    <a href="services-details.html" class="shine-animate"><img src="assets/img/services/businessmen-hands-white-table-with-documents-drafts.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                            <div class="services-item shine-animate-item">
                                ...
                                <div class="services-content">
                                    ...
                                    <p>Humantroop Ventures helps clients ensure compliance with legal regulations such as labor law.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="choose__area-two" style="margin:0 0 0 ;">
            <div class="choose__bg" data-background="assets/img/services/standard-quality-control-collage-concept.jpg" style="background-image: url(&quot;assets/img/standard-quality-control-collage-concept.jpg&quot;);"></div>
            <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="choose-content">
                            ...
                            <div class="section-title white-title mb-30 tg-heading-subheading animation-style3" style="color: #172364 !important;">
                                <span class="sub-title">Staffing Partners</span>
                                <h2 class="title tg-element-title" style="perspective: 400px;color: #172364 !important;">Expertise with the Spirit of Innovation</h2>
                            </div>
